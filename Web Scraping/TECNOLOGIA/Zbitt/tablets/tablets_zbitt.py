...
import requests
import csv
from TECNOLOGIA.Milar.smartphones.common_functions import *

# urllib

url_base = "https://www.zbittbilbao.com"
url = url_base + "/114-tabletas"
i = 0
with open(saveCSVpath("zbitt_tablets.csv"), 'w') as file:
    ...
    while True:
        ...
        for p in products:
            ...
            writer.writerow(['smartphones', 'Zbitt', name, finalPrice(price)])
