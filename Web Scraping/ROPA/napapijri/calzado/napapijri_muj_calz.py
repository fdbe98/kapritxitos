...
url = "https://www.napapijri.es/shop/es/npj-es/mujer-zapatos-y-accesorios-zapatos"
...
with open(saveCSVpath("napapijri_muj_calz.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'mujer', 'portatiles', 'Napapijri', name, finalPrice(price)])