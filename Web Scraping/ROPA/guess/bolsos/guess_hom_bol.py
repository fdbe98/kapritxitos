...
url = "https://www.guess.eu/es-es/guess/hombres/bolsos"
#SELENIUM --->
...
with open(saveCSVpath("guess_hom_bol.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'hombre', 'vestidos', 'Guess', name, finalPrice(price)])
driver.close()
