...
url = "https://www.guess.eu/es-es/guess/mujeres/bolsos"
#SELENIUM --->
...
with open(saveCSVpath("guess_muj_bol.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'mujer', 'vestidos', 'Guess', name, finalPrice(price)])
driver.close()
