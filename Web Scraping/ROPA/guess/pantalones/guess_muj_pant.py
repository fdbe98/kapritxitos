...
url = "https://www.guess.eu/es-es/guess/mujeres/prendas-de-vestir/pantalones"
#SELENIUM --->
...
with open(saveCSVpath("guess_muj_pant.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'mujer', 'pantalones', 'Guess', name, finalPrice(price)])
driver.close()
