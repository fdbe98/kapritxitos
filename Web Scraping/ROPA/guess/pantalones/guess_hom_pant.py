...
url = "https://www.guess.eu/es-es/guess/hombres/prendas-de-vestir/pantalones"
#SELENIUM --->
...
with open(saveCSVpath("guess_hom_pant.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'hombre', 'pantalones', 'Guess', name, finalPrice(price)])
driver.close()
