...
url = "https://www.guess.eu/es-es/guess/mujeres/zapatos"
#SELENIUM --->
...
with open(saveCSVpath("guess_muj_calz.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'mujer', 'portatiles', 'Guess', name, finalPrice(price)])
driver.close()
