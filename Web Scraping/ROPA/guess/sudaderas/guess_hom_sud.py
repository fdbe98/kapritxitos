...
url = "https://www.guess.eu/es-es/guess/hombres?q=sudadera"
...
with open(saveCSVpath("guess_hom_sud.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'hombre', 'sudaderas', 'Guess', name, finalPrice(price)])
driver.close()
