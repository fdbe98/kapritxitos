...
url = "https://www.guess.eu/es-es/guess/mujeres?q=sudadera"
#SELENIUM --->
...
with open(saveCSVpath("guess_muj_sud.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'mujer', 'sudaderas', 'Guess', name, finalPrice(price)])
driver.close()
