...
url = "https://www.guess.eu/es-es/guess/mujeres/prendas-de-vestir/t-shirt"
#SELENIUM --->
...
with open(saveCSVpath("guess_muj_camisetas.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'mujer', 'camisetas', 'Guess', name, finalPrice(price)])
driver.close()
