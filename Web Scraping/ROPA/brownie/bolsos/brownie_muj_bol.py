...
url = "https://www.browniespain.com/es/bolsos/"
...
with open(saveCSVpath("brownie_muj_bol.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'mujer', 'bolsos', 'Brownie', name, finalPrice(price)])
driver.close()