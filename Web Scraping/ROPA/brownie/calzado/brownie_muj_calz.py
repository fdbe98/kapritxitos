...
url = "https://www.browniespain.com/es/zapatos/"
...
with open(saveCSVpath("brownie_muj_calz.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'mujer', 'portatiles', 'Brownie', name, finalPrice(price)])
driver.close()