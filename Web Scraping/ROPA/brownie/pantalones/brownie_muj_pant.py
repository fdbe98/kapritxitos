...
url = "https://www.browniespain.com/es/pantalones/"
...
with open(saveCSVpath("brownie_muj_pant.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'mujer', 'pantalones', 'Brownie', name, finalPrice(price)])
driver.close()