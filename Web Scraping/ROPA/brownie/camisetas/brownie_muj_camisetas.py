...
url = "https://www.browniespain.com/es/camisetas/"
...
with open(saveCSVpath("brownie_muj_camisetas.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'mujer', 'camisetas', 'Brownie', name, finalPrice(price)])
driver.close()