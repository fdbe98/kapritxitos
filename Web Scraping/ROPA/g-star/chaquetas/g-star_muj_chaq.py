...
url = "https://www.g-star.com/es_es/shop/mujeres/chaquetas_y_americanas"
...
with open(saveCSVpath("g-star_muj_chaq.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'mujer','chaqueta','G-STAR',name, finalPrice(price)])
