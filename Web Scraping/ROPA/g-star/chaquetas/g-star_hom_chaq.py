...
url = "https://www.g-star.com/es_es/shop/hombres/chaquetas_y_americanas"
...
with open(saveCSVpath("g-star_hom_chaq.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'hombre','chaquetas','G-STAR',name, finalPrice(price)])
