...
url = "https://www.g-star.com/es_es/shop/mujeres/sudaderas"
...
with open(saveCSVpath("g-star_muj_sud.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'mujer','sudaderas','G-STAR',name, finalPrice(price)])
