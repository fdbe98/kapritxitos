...
url = "https://www.g-star.com/es_es/shop/hombres/sudaderas"
...
with open(saveCSVpath("g-star_hom_sud.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'hombre','sudaderas','G-STAR',name, finalPrice(price)])
