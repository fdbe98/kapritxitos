...
url = "https://www.g-star.com/es_es/shop/hombres/camisetas"
...
with open(saveCSVpath("g-star_hom_camisetas.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'hombre','camisetas','G-STAR',name, finalPrice(price)])
