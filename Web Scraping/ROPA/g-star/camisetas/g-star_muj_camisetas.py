...
url = "https://www.g-star.com/es_es/shop/mujeres/camisetas"
...
with open(saveCSVpath("g-star_muj_camisetas.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'mujer','camisetas','G-STAR',name, finalPrice(price)])
