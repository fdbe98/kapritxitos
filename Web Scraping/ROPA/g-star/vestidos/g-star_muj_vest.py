...
url = "https://www.g-star.com/es_es/shop/mujeres/vestidos"
...
with open(saveCSVpath("g-star_muj_vest.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'mujer','vestidos','G-STAR',name, finalPrice(price)])
