...
url = "https://www.g-star.com/es_es/shop/hombres/pantalones"
...
with open(saveCSVpath("g-star_hom_pant.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'hombre','pantalones','G-STAR',name, finalPrice(price)])
