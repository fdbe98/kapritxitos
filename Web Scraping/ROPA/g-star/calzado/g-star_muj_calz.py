...
url = "https://www.g-star.com/es_es/shop/mujeres/calzado"
...
with open(saveCSVpath("g-star_muj_calz.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'mujer','portatiles','G-STAR',name, finalPrice(price)])
