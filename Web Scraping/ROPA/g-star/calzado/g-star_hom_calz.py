...
url = "https://www.g-star.com/es_es/shop/hombres/calzado"
...
with open(saveCSVpath("g-star_hom_calz.csv"), 'w') as file:
    ...
    for p in products:
        ...
        print(i, price, name)
        writer.writerow([i, 'hombre','portatiles','G-STAR',name, finalPrice(price)])
