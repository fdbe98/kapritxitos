...
url = "https://coquette-bilbao.com/categoria/vestidos/"
...
while True:
    ...
    with open(saveCSVpath("coquette_muj_vest.csv"), 'a') as file:
        ...
        for p in products:
            ...
            print(i, price, name)
            writer.writerow([i, 'mujer', 'vestidos', 'Coquette', name, finalPrice(price)])
